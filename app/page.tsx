...
function DashboardTable({
  ...
  const allCols: Col[] = [
    ...
    { label: '市場', cls: styles.thLeft, key: 'market' as keyof StockRow, w: 72, group: '', detail: true },
    ...
    { label: 'PER位置', cls: `${styles.thRight} ${styles.thPerGroup}`, key: null, w: 130, group: 'per', tooltip: '直近1年のPER高値〜安値の中で、\n今の予想PER（会社予想ベース）がどこにあるかを示すバー。\n左=安値(割安)、右=高値(割高)、●=現在の予想PER。\n赤字/非開示などで出せない時は理由を表示。' },
    { label: '来期売上成長',cls: `${styles.thRight} ${styles.thPerGroup}`, key: 'nySalesGr' as keyof StockRow, w: 100, group: 'per', detail: true, tooltip: '来期予想売上÷最新FY確定売上−1。\nPEGの構成要素（成長率）。\n15%超で高成長企業の目安。' },
