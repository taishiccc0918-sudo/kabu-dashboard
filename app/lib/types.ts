// 新規ユーザーのデフォルト銘柄（3銘柄からスタート）
export const DEFAULT_WATCHLIST = ['7203', '8306', '8058']

// たいしの全ウォッチリスト（Supabase SQL復元用・管理者参照）
export const TAISHI_WATCHLIST = [
...
export type TabKey = 'dashboard' | 'card' | 'watchlist' | 'report' | 'news'
